...
export default function POVDefineCanvas({ 
  isReadOnly, 
  userVal = "", 
  needsVal = "", 
  insightVal = "", 
      ...
      <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input 
              value={userVal}
              onChange={(e) => onUpdate && onUpdate("user", e.target.value)}
              disabled={isReadOnly} 
              ...
              placeholder="e.g., A busy college student..." 
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              value={insightVal}
              onChange={(e) => onUpdate && onUpdate("insight", e.target.value)}
              disabled={isReadOnly}
