...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-blue-500/30">
      ...
      {/* GLOBAL HEADER */}
      <header className="h-14 shrink-0 flex items-center justify-between px-6 border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <Avatar className="h-8 w-8 border border-zinc-800">
            <AvatarFallback className="bg-zinc-800 text-xs text-zinc-300">ST</AvatarFallback>
          </Avatar>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-1">
            <h2 className="text-3xl font-bold tracking-tight text-white">Welcome back, Student!</h2>
            <p className="text-zinc-400">Ready to continue your innovation journey?</p>
          </div>

          {recentProject && (
            <Card className="bg-zinc-900 border-zinc-800 shadow-xl overflow-hidden relative group">
              ...
              <CardContent className="p-0 sm:flex items-stretch relative z-10">
                ...
                <div className="bg-zinc-950/50 p-8 sm:w-1/3 flex flex-col items-center justify-center border-b sm:border-b-0 sm:border-r border-zinc-800">
                  ...
                  <Badge variant="outline" className={`${PHASE_MAP[recentProject.currentPhase].border} ${PHASE_MAP[recentProject.currentPhase].color} bg-zinc-950 px-3 py-1 text-xs uppercase tracking-wider`}>
                ...
                <div className="p-8 sm:w-2/3 flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl font-bold text-zinc-100 mb-6 group-hover:text-blue-400 transition-colors">
                    {recentProject.title}
                  </h3>
                  ...
                  <div className="space-y-2 mb-8 max-w-md">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-zinc-300 font-bold">{recentProject.progressPercentage}%</span>
                    </div>
                    {/* Replaced shadcn Progress with explicit Left-to-Right div implementation */}
                    <div className="h-2 w-full bg-zinc-800 rounded-full overflow-hidden flex justify-start">
                      <div 
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <CardHeader className="pb-4 border-b border-zinc-800/50 bg-zinc-950/30">
                  <div className="flex justify-between items-start gap-4">
                    <CardTitle className="text-lg font-semibold leading-tight text-zinc-200 group-hover:text-white transition-colors">
                      {project.title}
                    </CardTitle>
                ...
                <CardContent className="py-5 flex-1 space-y-4">
                  <div className="flex items-center gap-2">
                     <Badge variant="outline" className={`text-[10px] uppercase tracking-wider font-semibold border-zinc-700 text-zinc-400 bg-zinc-950/50`}>
                        {PhaseData.label}
                     </Badge>
                  </div>
                  ...
                  <div className="space-y-1.5 pt-2">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="text-zinc-400 font-medium">{project.progressPercentage}%</span>
                    </div>
                    {/* Explicit Left-to-Right div implementation */}
                    <div className="h-1.5 w-full bg-zinc-800 rounded-full overflow-hidden flex justify-start">
                      <div 
          ...
          >
             ...
             <p className="text-sm font-medium text-zinc-400">Start New Project</p>
          </Card>
